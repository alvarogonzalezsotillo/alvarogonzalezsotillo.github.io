...
#+DATE:        2019-10-06
#+URI:         /blog/pihole-monitorizacion-red
...
En nuestro centro todas las aulas comparten la misma [[https://es.wikipedia.org/wiki/VLAN][=VLAN=]], y la asignación de =IP= se hace dinámicamente por =DHCP=, por lo que *la localización del PC atacante fue cuestión de suerte*. Si el alumno hubiera utilizado una máquina virtual en modo /bridged/, tendríamos que haber localizado el aula desconectando poco a poco los switches.
